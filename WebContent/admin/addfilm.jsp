			...
			<form action="film/addFilm.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 80%">
					...
					<div class="formRow">
						<label>菜品名称</label>
						<div class="formRight">
							<input type="text" name="filmname" class="mws-textinput" id="filmname" placeholder="请输入菜品名称" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						<label>单价</label>
						<div class="formRight">
							<input type="text" name="price" class="mws-textinput" id="price" placeholder="请输入单价" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						...
						<div class="formRight">
							...
							<textarea cols="80" name="contents" id="contents" rows="10" placeholder="请输入菜品介绍"> </textarea>
